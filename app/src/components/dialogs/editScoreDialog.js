...
export function EditScoreDialog({ children, submission }) {
    ...
    const handleConfirm = () => {
        ...
        axios.put(`${config.backendUrl}/score`, data)
        .then((response) => {
        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Change the score and feedback for the submission.
                    </DialogDescription>
                </DialogHeader>
